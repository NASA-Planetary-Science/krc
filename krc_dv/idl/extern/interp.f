...
C_Titl  INTERP  Differentiates and interpolates a set of Chebyshev coefficients
C      to give position and velocity
C
...
C
C
C_Hist  original version from Standish CDROM 
C  2000dec08 Hugh Kieffer, modify comments and declarations
...
C
      ...
      DATA VC(2)/1.D0/
D      write(*,*)'INTERP:T,NCF,NCM,NA,IFL=',T,NCF,NCM,NA,IFL ! hhk
